  ...
  return (
    <section id="home">
      <div className="flex flex-col items-center justify-center h-screen overflow-hidden from-black via-zinc-600/20 to-black">
        ...
        <h1 className="z-10 text-transparent duration-1000 bg-white text-edge-outline animate-title sm:text-6xl md:text-9xl whitespace-nowrap bg-clip-text tracking-tighter">
          I'm Sean Chuah
        </h1>
